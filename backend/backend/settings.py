...
SECRET_KEY = 'django-insecure-!78tjqh7asnq4kno+dj1col)#w+)#g91nd6=(k&3%!ljiyqk$+'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(days=30), # here we can change token last time minutes to days
